...
// Record types
enum {
    QK_DEMO_RECORD_SNAPSHOT  = 1,
    QK_DEMO_RECORD_USERCMD   = 2,
    QK_DEMO_RECORD_EVENT     = 3,
    QK_DEMO_RECORD_GAMESTATE = 4,
    QK_DEMO_RECORD_END       = 255,
};
...
_Static_assert(sizeof(qk_demo_header_t) == 48,
               "demo header must be exactly 48 bytes");
_Static_assert(sizeof(qk_demo_record_t) == 8,
               "demo record preamble must be exactly 8 bytes");
